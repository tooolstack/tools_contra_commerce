...
const definitions: Record<LaunchToolSlug, { title: string; description: string }> = {
  ...
  'social-media-tools': { title: 'Social Media Tools', description: 'Create, format, check and measure social media content with 12 focused tools in one workspace.' },
  ...
  'travel-tools': { title: 'Travel Budget Calculator', description: 'Calculate total, per-person and daily travel budgets, then prepare packing, currency, luggage, schedules and more in one workspace.' },
